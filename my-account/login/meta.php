...
<script src="<?php echo $website_url?>/my-account/login/js/jquery-v3.6.1.min.js"></script>
<script src="<?php echo $website_url?>/my-account/login/js/scripts.js?v=<?php echo $code_version?>"></script>
