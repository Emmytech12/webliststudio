            ...
            <div class="top-title">
                <div class="div-in">
                    <ul>
                        ...
                        <a href="<?php echo $website_url?>/contact-us"><li title="Contact Us">Contact Us</li></a>					
                    </ul>
                </div>			
            </div>
    ...
    <section class="others-pg-content-div">
        <div class="menu-btn-div">
            <div class="btn-div-in">
                <button class="menu-btn active-btn" id="next-usa" title="SAN FRANCISCO ADDRESS" onclick="_next_contact_page('usa-hide-div','usa');">SAN FRANCISCO ADDRESS</button>
                <button class="menu-btn" id="next-nigeria" title="NIGERIA ADDRESS" onclick="_next_contact_page('nigeria-hide-div','nigeria');">NIGERIA ADDRESS</button>          
            </div>
        </div>
                ...
                <div class="bottom-body-div">
                    ...
                    <div class="contact-div animated zoomIn">
                        ...
                        <div class="icon img-div"><img src="all-images/images/location.png" alt="<?php echo $thename?> Office Address"/></div>
                            ...
                            <div class="text">
                                <h2>LOCATION</h2> 
                                <p>2149 E 23rd Street Oakland CA 94606 US</p>
                            </div>                  
                        </div>
                    </div>
                </div>
        ...
        <div id="nigeria-hide-div">
            ...
            <section class="map-body-div">
                <div class="map-back-div"> 
                    <iframe allowfullscreen="" class="google-map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d253682.4631078896!2d3.119143053662222!3d6.548369370561364!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x103b8b2ae68280c1%3A0xdc9e87a367c3d9cb!2sLagos!5e0!3m2!1sen!2sng!4v1724092247284!5m2!1sen!2sng"></iframe>
                </div>
            </section> 
        </div>
