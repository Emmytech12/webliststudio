...
<link href="<?php echo $website_url?>/login/style/main-style.css?v=<?php echo $code_version?>" type="text/css" rel="stylesheet" />

<script src="<?php echo $website_url?>/sign-up/js/jquery-v3.6.1.min.js"></script>
<script src="<?php echo $website_url?>/sign-up/js/scripts.js?v=<?php echo $code_version?>"></script>
