        ...
        <div class="container-back-div">
            <div class="inner-container">
                ...
                <div class="text_field_container extension_text_field_container" id="selectContainer">
                    <select class="text_field selectSearch" placeholder="" id="searchRole"
                        onclick="_selectOption('searchRole')" style="opacity: 1;">
                        <option selected="selected" value="">-Select Role-</option>
                    </select>
                    
                    <div class="placeholder">Select Here</div>
                    <div class="searchPanel animated fadeIn" id="searchPanel_searchRole"
                        style="display: none;">
                        <input class="searchTxt" placeholder="Type here to search"
                            id="txtSearchValue_searchRole" autocomplete="off"
                            onkeyup="filter('searchRole')">
                        <ul id="searchList_searchRole" data-aos="fade-up" data-aos-duration="200"
                            class="aos-init aos-animate">
                            <li onclick="_clickOption('searchList_searchRole', 'Super Admin', 'Super Admin')">Super Admin</li>
                            <li onclick="_clickOption('searchList_searchRole', 'Admin', 'Admin')">Admin</li>
                            <li onclick="_clickOption('searchList_searchRole', 'Staff', 'Staff')">Staff</li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="slide-form-div" data-aos="fade-left" data-aos-duration="900">
        ...
        <div class="container-back-div">
            <div class="inner-container">
                ...
                <div class="text_field_container extension_text_field_container" id="selectContainer">
                    <select class="text_field selectSearch" placeholder="" id="searchBlogCat"
                        onclick="_selectOption('searchBlogCat')" style="opacity: 1;">
                        <option selected="selected" value="">-Select Blog Category-</option>
                    </select>
                    
                    <div class="placeholder">Select Here</div>
                    <div class="searchPanel animated fadeIn" id="searchPanel_searchBlogCat"
                        style="display: none;">
                        <input class="searchTxt" placeholder="Type here to search"
                            id="txtSearchValue_searchBlogCat" autocomplete="off"
                            onkeyup="filter('searchBlogCat')">
                        <ul id="searchList_searchBlogCat" data-aos="fade-up" data-aos-duration="200"
                            class="aos-init aos-animate">
                            <li onclick="_clickOption('searchList_searchBlogCat', 'General', 'General')">General</li>
                            <li onclick="_clickOption('searchList_searchBlogCat', 'Announcement', 'Announcement')">Announcement</li>
                            <li onclick="_clickOption('searchList_searchBlogCat', 'Domain', 'Domain')">Domain</li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="slide-form-div" data-aos="fade-left" data-aos-duration="900">
        ...
        <div class="container-back-div">
            <div class="inner-container">
                ...
                <div class="text_field_container extension_text_field_container" id="selectContainer">
                    <select class="text_field selectSearch" placeholder="" id="searchFaqCat"
                        onclick="_selectOption('searchFaqCat')" style="opacity: 1;">
                        <option selected="selected" value="">-Select FAQ Category-</option>
                    </select>
                    
                    <div class="placeholder">Select Here</div>
                    <div class="searchPanel animated fadeIn" id="searchPanel_searchFaqCat"
                        style="display: none;">
                        <input class="searchTxt" placeholder="Type here to search"
                            id="txtSearchValue_searchFaqCat" autocomplete="off"
                            onkeyup="filter('searchFaqCat')">
                        <ul id="searchList_searchFaqCat" data-aos="fade-up" data-aos-duration="200"
                            class="aos-init aos-animate">
                            <li onclick="_clickOption('searchList_searchFaqCat', 'General', 'General')">General</li>
                            <li onclick="_clickOption('searchList_searchFaqCat', 'Announcement', 'Announcement')">Announcement</li>
                            <li onclick="_clickOption('searchList_searchFaqCat', 'Domain', 'Domain')">Domain</li>
                        </ul>
                    </div>
                </div>
