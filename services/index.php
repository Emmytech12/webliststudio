...
<head>
    ...
    <title><?php echo $thename?> | Services</title>
        ...
        <div class="other-pages-back-div">
            <div class="top-title">
                <div class="div-in">
                    <ul>
                        ...
                        <a href="<?php echo $website_url?>/services"><li title="Our Services">Our Services</li></a>					
                    </ul>
                </div>			
            </div>
            ...
            <div class="main-content-back-div">
                <div class="text-content-div" data-aos="fade-in" data-aos-duration="900">
                    ...
                    <p>At Weblist Studio, we specialize in offering top-notch web hosting and web development services tailored to meet your needs. Whether you’re looking for reliable hosting solutions or custom website designs, our expert team is here to help you succeed online.</p>                
                ...
                <div class="image-div">
                    <img src="<?php echo $website_url?>/all-images/body-pix/services.svg" alt="<?php echo $thename?> services" />
                </div>
            </div>
        ...
        <section class="body-div net-bg-br">
            <div class="body-div-in">
                <div class="main-pages-back-div">
                    <div class="title-div animated fadeInUp">
